...
//using useState to set the default values for the array of Photos 
    const [photos] = useState([
      ...
      //goes through each photo in the photo array and finds every photo that matches the category that
      //was selected by the user.  If the photo matches the condition, it is returned in an array and 
